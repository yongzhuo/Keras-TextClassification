...
# @author   :Mo
# @function :train of SWEM with baidu-qa-2019 in question title
...
# 模型图
from keras_textclassification.m15_SWEM.graph import SWEMGraph as Graph
# 计算时间
import time
...
def train(hyper_parameters=None, rate=1.0):
    if not hyper_parameters:
        ...
        'model': {'label': 17,  # 类别数
                  ...
                  # SWEM参数
                  'encode_type': 'HIERARCHICAL',  # MAX, AVG, CONCAT, HIERARCHICAL
                  'n_win': 3
                  },
