...
from keras_textclassification.conf.path_config import path_embedding_random_word
...
if __name__=="__main__":
    hyper_parameters = {'model': {   'label': 17,
                        ...
                        'embedding':{ 'embedding_type': 'random',
                                      'corpus_path': path_embedding_random_word, # word字典暂时没有，可以自己设置, 文件名必须带"term"字符
                                      'level_type': 'word',
                                      'embed_size': 300,
                                      'len_max': 50,},
                         }
